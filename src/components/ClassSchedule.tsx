  ...
  const schedules: Record<number, ClassType[]> = {
    ...
    3: [
      // Среда
      {
        ...
        time: "10:45 - 12:15",
        title: "Базы данных",
        professor: "Соколов М.А.",
        location: "Аудитория 403",
        type: "лекция",
      },
      {
        id: 7,
                ...
                <div key={cls.id}>
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge
                        variant={getTypeColor(cls.type) as any}
                        className="ml-2"
                      >
                        <Icon
                          name={getTypeIcon(cls.type)}
                          size={14}
                          className="mr-1"
                        />
                        {cls.type}
